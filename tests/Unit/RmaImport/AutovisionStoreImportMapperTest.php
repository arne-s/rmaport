...
use App\Support\RmaImport\AutovisionStore\AutovisionStoreImportMapper;
use Tests\TestCase;

uses(TestCase::class);

it('maps autovision store rows with metadata and homar brand alias', function (): void {
    $mapper = new AutovisionStoreImportMapper;
