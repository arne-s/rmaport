...
<html
    ...
    class="app filament js-focus-visible min-h-screen antialiased"
    @class([
        'fi',
...
>
    ...
    <head>
        ...
        @vite(['resources/scss/overrides/filament/admin.scss'])
        @vite(['resources/scss/overrides/filament/adminMenu.scss'])
    ...
    @php
        ...
        if ($livewire instanceof ResourcePage) {
            $resourceBodyClasses[] = 'resource-' . $livewire::getResource()::getSlug();
            $resourceBodyClasses[] = 'method-' . $livewire::getResourcePageName();

            if (method_exists($livewire, 'getRecord')) {
                $record = $livewire->getRecord();

                if ($record instanceof Model) {
                    $resourceBodyClasses[] = 'resource-id-' . $record->getKey();
                }
            }
        }
    @endphp
