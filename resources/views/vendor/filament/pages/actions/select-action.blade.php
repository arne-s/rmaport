<div class="filament-page-select-action">
    ...
    <select
        ...
        {{ $attributes->class([
            'text-gray-900 border-gray-300 invalid:text-gray-400 block w-full h-9 py-1 transition duration-75 rounded-lg shadow-xs outline-hidden focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500',
