...
<div class="fi-resource-relation-managers-container space-y-2">
            ...
            <x-filament::tabs>
                ...
                @foreach ($tabs as $tabKey => $manager)
                    ...
                    <button
                        ...
                        type="button"
                        @class([
                            'flex whitespace-nowrap items-center h-8 px-5 font-medium rounded-lg outline-hidden focus:ring-2 focus:ring-primary-600 focus:ring-inset',
                            ...
                            'text-primary-600 shadow-sm bg-white' => $activeManager === $tabKey,
    ...
    @if (filled($activeManager) && isset($managers[$activeManager]))
        <div
            @if (count($managers) > 1)
                ...
                tabindex="0"
            @endif
            class="space-y-4 outline-hidden"
        >
