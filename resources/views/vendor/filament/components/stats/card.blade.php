...
<{!! $tag !!}
    {{ $attributes->merge($extraAttributes)->class([
        'filament-stats-card relative p-2 rounded-2xl bg-white border border-solid border-gray-500',
...
>
    ...
    <div @class([
        ...
        <div class="px-2 py-1 widgetContentBlock offerteBlock">
            <div @class([
                'flex items-center rtl:space-x-reverse text-m font-medium text-gray-200 titleBlock',
