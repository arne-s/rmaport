...
@section('title', 'Nieuwe dealer aanvraag')

@section('content')
    <div style="background: #F8F8F8; border: 2px solid #D8D8D8;
    padding: 45px; text-align: center; margin-top: 10px; margin-bottom: 60px">

        <h2 style="padding-top: 0; margin-top: 0">Nieuwe dealer aanvraag</h2>

        <p style="font-size: 16px">Er is een nieuwe dealer aanvraag binnengekomen op de website.</p>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                <th style="border: 1px solid #D8D8D8; padding: 8px; text-align: left;">KVK-nummer</th>
                <td style="border: 1px solid #D8D8D8; padding: 8px;">{{ $entry->kvk }}</td>
            </tr>
            <tr>
