@if ($showProductAddedToPurchaseBucketModal ?? false)
    @teleport('body')
        <div
            class="status-confirm-modal status-confirm-modal--no-close fi-fo-field-wrp"
            role="dialog"
            aria-modal="true"
            aria-labelledby="product-added-to-purchase-bucket-title"
            wire:key="product-added-to-purchase-bucket-modal"
        >
            <div
            ...
            >
                <div class="fi-modal-header">
                    ...
                    <div>
                        <h2 id="product-added-to-purchase-bucket-title" class="fi-modal-heading">Let op</h2>
                        <p class="fi-modal-description">
                            Je voegt een artikel toe. Deze wordt toegevoegd aan de Artikelen/Bucket tab (Openstaand) om in te kopen.
                        </p>
                    </div>
                </div>
                <div class="fi-modal-footer fi-align-center">
                    <div class="fi-modal-footer-actions">
                        <x-filament::button
                            wire:click="dismissProductAddedToPurchaseBucketModal"
