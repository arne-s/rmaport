...
<x-filament-widgets::widget class="filament-widgets-chart-widget">
    <x-filament::card>
            ...
            <div class="flex items-center justify-between gap-8">
                ...
                @if ($filters)
                    <select
                        ...
                        @class([
                            'text-gray-900 border-gray-300 block h-10 transition duration-75 rounded-lg shadow-xs outline-hidden focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500',
        ...
        <div class="chartData" {!! ($pollingInterval = $this->getPollingInterval()) ? "wire:poll.{$pollingInterval}=\"updateChartData\"" : '' !!}>
            <canvas
                x-data="{
                    chart: null,
                    init: function () {
