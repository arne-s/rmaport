...
class QuoteMailDealer extends Mailable
{
    ...
    {
        $this->quote->loadMissing(['customer', 'billingCustomer', 'main.billingCustomer', 'quoteApproval']);
        ...
        $customerName = $this->quote->resolveDealerMailSalutation();
    ...
    {
        return new static(
            quote: Quote::resolveForEmailPreview(OrderSubtype::Service, dealerOnly: true),
            primaryRecipientKey: 'dealer',
        );
    }
