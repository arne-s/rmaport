...
class QuoteMailCustomer extends Mailable
{
    ...
    {
        $this->quote->loadMissing(['customer', 'billingCustomer', 'main', 'quoteApproval']);
    ...
    {
        return new static(
            quote: Quote::resolveForEmailPreview(OrderSubtype::Service, dealerOnly: false),
            primaryRecipientKey: 'customer',
        );
    }
