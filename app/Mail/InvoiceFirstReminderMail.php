...
/**
 * Eerste betalingsherinnering slot- of aanbetalingsfactuur (DB template: {@see self::class}).
 */
class InvoiceFirstReminderMail extends Mailable
{
    ...
    public static function preview(): static
    {
        ...
        if (! $invoice instanceof Invoice) {
            throw new RuntimeException('No slot invoice with main found for first reminder mail preview.');
        }
