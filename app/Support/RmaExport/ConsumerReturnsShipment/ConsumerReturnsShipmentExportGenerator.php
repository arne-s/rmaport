...
namespace App\Support\RmaExport\ConsumerReturnsShipment;
...
final class ConsumerReturnsShipmentExportGenerator implements RmaExportGenerator
{
    ...
    public function __construct(
        ...
        private readonly ConsumerReturnsShipmentImportMapper $mapper = new ConsumerReturnsShipmentImportMapper,
    ...
    public function generate(ImportBatch $batch, ImportExport $export): string
    {
        ...
        for ($index = $headerIndex + 1; $index < count($sheetRows); $index++) {
            ...
            if ($this->consumerReturnsMapper->supportsHeaders($normalized)) {
                continue;
            }
