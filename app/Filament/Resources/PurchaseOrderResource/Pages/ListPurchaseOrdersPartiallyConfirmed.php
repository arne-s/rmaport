...
class ListPurchaseOrdersPartiallyConfirmed extends ListPurchaseOrders
{
    ...
    public ?string $status = 'partially-confirmed';
    ...
    {
        return [PurchaseOrderStatus::PartiallyConfirmed->value];
    }

    public function getBreadcrumbs(): array
    {
        return array_merge(parent::getSubpageBreadcrumbs(), ['Gedeeltelijk bevestigd']);
    }
