...
class ListPurchaseOrdersPartiallyDelivered extends ListPurchaseOrders
{
    ...
    public ?string $status = 'partially-delivered';
    ...
    {
        return [PurchaseOrderStatus::PartiallyDelivered->value];
    }

    public function getBreadcrumbs(): array
    {
        return array_merge(parent::getSubpageBreadcrumbs(), ['Gedeeltelijk geleverd']);
    }
            ...
            ->columns([
                TextColumn::make('created_at')
                    ...
                    ->formatStateUsing(function ($state, array $record): HtmlString {
                        ...
                        return $dt instanceof Carbon
                            ? new HtmlString('<div class="numberPlusDate noBorder">' . $dt->translatedFormat('d-m-Y') . '</div>')
                            : new HtmlString('');
                    }),
                ...
                TextColumn::make('document_ref')
                    ...
                    ->formatStateUsing(function ($state, array $record): HtmlString {
                        if ($record['kind'] === 'po') {
                            ...
                            return ($po->reference_number === null || $po->reference_number === '')
                                ? new HtmlString('<span class="text-gray-400 text-sm"><em>In behandeling...</em></span>')
                                : new HtmlString(
                ...
                TextColumn::make('latestExpectedDeliveryDate')
                    ...
                    ->formatStateUsing(function ($state, array $record): string {
                        ...
                        $date = $record['purchaseOrder']->latestExpectedDeliveryDate;

                        return $date ? $date->isoFormat('\W\e\e\k W, Y') : '';
                    })
                ...
                SelectColumn::make('status')
                    ->options(fn(array $record): array => $record['kind'] === 'ro' ? $roStatuses : $poStatuses)
