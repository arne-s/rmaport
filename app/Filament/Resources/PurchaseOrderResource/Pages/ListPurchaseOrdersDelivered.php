...
class ListPurchaseOrdersDelivered extends ListPurchaseOrders
{
    ...
    {
        return [PurchaseOrderStatus::Delivered->value];
    }

    public function getBreadcrumbs(): array
    {
        return array_merge(parent::getSubpageBreadcrumbs(), ['Geleverd']);
    }
